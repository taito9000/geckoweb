...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
    ...
    <body>
        ...
        <div class="mainContents__title">
            ...
            <div class="mainContents__text">
                <div class="mainContents__img">
                    <img class="mainContents__imgContents" src="{{ asset('/photo/desertcage (1).jpg')}}">
                </div>
        ...
        <div class="mainContents__title">
            ...
            <div class="mainContents__text">
                <div class="mainContents__img">
                    <img class="mainContents__imgContents" src="{{ asset('/photo/panelHeater (1).jpg')}}">
                </div>
        ...
        <div class="mainContents"> 
        <div class="mainContents__title" id='#bedding'>
            床材
            </div>
            <div class="mainContents__text">
                <div class="mainContents__img">
                    <img class="mainContents__imgContents" src="{{ asset('/photo/kitchenpaper (1).jpg')}}">
                </div>
        ...
        <div class="mainContents__title">
            シェルター
            </div><a href='#shelter'></a>
            <div class="mainContents__text">
                <div class="mainContents__img">
                    <img class="mainContents__imgContents" src="{{ asset('/photo/sudowetshelter (1).jpg')}}">
                </div>
        ...
        <div class="mainContents__title">
            温度計
            </div><a href='#thermometer'></a>
            <div class="mainContents__text">
                <div class="mainContents__img">
                    <img class="mainContents__imgContents" src="{{ asset('/photo/thermometer (1).jpg')}}">
                </div>
       ...
       <div class="mainContents__title">
            脱皮不全
            </div> <a href='#misshedding'></a>
            <div class="mainContents__text">
               
                しっかりと湿度を保っていても、脱皮不全といって、一部だけ脱皮しきれていない部分がある
                   状態になることがあります。指先がなりやすいかと思います。特に冬ですね。そんな時は
                   ある程度密閉できるものにキッチンペーパーなどを入れ多めに霧吹きをし、脱皮不全で残
                   った皮をふやかします。そして、取ってあげて下さい。
